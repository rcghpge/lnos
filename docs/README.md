...
> For mainline Arch Linux, we recommend installation and following the official [Arch Linux installation guide](https://wiki.archlinux.org/title/Installation_guide) for the most accurate and up-to-date instructions.
